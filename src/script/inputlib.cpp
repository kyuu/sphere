    ...
    namespace script {
        namespace internal {
            ...
            static util::Constant _input_constants[] = {
                ...
                {"KEY_LALT",            input::KEY_LALT            },
                {"KEY_RALT",            input::KEY_RALT            },
                {"KEY_NUMPAD_0",        input::KEY_NUMPAD_0        },
                {"KEY_NUMPAD_1",        input::KEY_NUMPAD_1        },
                {"KEY_NUMPAD_2",        input::KEY_NUMPAD_2        },
                {"KEY_NUMPAD_3",        input::KEY_NUMPAD_3        },
                {"KEY_NUMPAD_4",        input::KEY_NUMPAD_4        },
                {"KEY_NUMPAD_5",        input::KEY_NUMPAD_5        },
                {"KEY_NUMPAD_6",        input::KEY_NUMPAD_6        },
                {"KEY_NUMPAD_7",        input::KEY_NUMPAD_7        },
                {"KEY_NUMPAD_8",        input::KEY_NUMPAD_8        },
                {"KEY_NUMPAD_9",        input::KEY_NUMPAD_9        },
                {"KEY_ADD",             input::KEY_ADD             },
                {"KEY_SUBTRACT",        input::KEY_SUBTRACT        },
                {"KEY_MULTIPLY",        input::KEY_MULTIPLY        },
                {"KEY_DIVIDE",          input::KEY_DIVIDE          },
